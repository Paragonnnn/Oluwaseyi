...
const Stacks = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 flex-wrap mt-4 justify-between md:justify-start m-auto">
        {stackList.map((stack, index) => (
          <div
            key={index}
            className={`${
              theme === "dark" ? "bg-gray-500/20" : "bg-gray-200/50"
            } flex flex-col items-center gap-2 mt-4 py-1 w-[150px] sm:w-[200px] rounded-2xl grow`}
          >
            <div className="w-[40px] h-[40px] flex items-center justify-center">
              {stackIcons[index]}
            </div>
            <div className="text-center max-w-[90%] overflow-hidden truncate">
